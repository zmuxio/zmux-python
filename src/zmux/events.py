...
from .errors import (
    ...
    error_direction as _error_direction,
    error_operation as _error_operation,
    error_reason as _error_reason,
    error_scope as _error_scope,
    error_source as _error_source,
    error_termination_kind as _error_termination_kind,
