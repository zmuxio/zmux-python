...
CAPABILITY_PRIORITY_HINTS = int(Capability.PRIORITY_HINTS)
CAPABILITY_STREAM_GROUPS = int(Capability.STREAM_GROUPS)
CAPABILITY_PRIORITY_UPDATE = int(Capability.PRIORITY_UPDATE)
CAPABILITY_OPEN_METADATA = int(Capability.OPEN_METADATA)
CAPABILITY_METADATA_CARRIAGE_MASK = CAPABILITY_OPEN_METADATA | CAPABILITY_PRIORITY_UPDATE

SETTING_INITIAL_MAX_STREAM_DATA_BIDI_LOCALLY_OPENED = int(
    SettingID.INITIAL_MAX_STREAM_DATA_BIDI_LOCALLY_OPENED
)
SETTING_INITIAL_MAX_STREAM_DATA_BIDI_PEER_OPENED = int(
    SettingID.INITIAL_MAX_STREAM_DATA_BIDI_PEER_OPENED
)
SETTING_INITIAL_MAX_STREAM_DATA_UNI = int(SettingID.INITIAL_MAX_STREAM_DATA_UNI)
SETTING_INITIAL_MAX_DATA = int(SettingID.INITIAL_MAX_DATA)
SETTING_MAX_INCOMING_STREAMS_BIDI = int(SettingID.MAX_INCOMING_STREAMS_BIDI)
SETTING_MAX_INCOMING_STREAMS_UNI = int(SettingID.MAX_INCOMING_STREAMS_UNI)
SETTING_MAX_FRAME_PAYLOAD = int(SettingID.MAX_FRAME_PAYLOAD)
SETTING_MAX_CONTROL_PAYLOAD_BYTES = int(SettingID.MAX_CONTROL_PAYLOAD_BYTES)
SETTING_MAX_EXTENSION_PAYLOAD_BYTES = int(SettingID.MAX_EXTENSION_PAYLOAD_BYTES)
SETTING_SCHEDULER_HINTS = int(SettingID.SCHEDULER_HINTS)
SETTING_PING_PADDING_KEY = int(SettingID.PING_PADDING_KEY)
SETTING_PREFACE_PADDING = int(SettingID.PREFACE_PADDING)

METADATA_STREAM_PRIORITY = int(MetadataType.STREAM_PRIORITY)
METADATA_STREAM_GROUP = int(MetadataType.STREAM_GROUP)
METADATA_OPEN_INFO = int(MetadataType.OPEN_INFO)

DIAG_DEBUG_TEXT = int(DiagnosticType.DEBUG_TEXT)
DIAG_RETRY_AFTER_MILLIS = int(DiagnosticType.RETRY_AFTER_MILLIS)
DIAG_OFFENDING_STREAM_ID = int(DiagnosticType.OFFENDING_STREAM_ID)
DIAG_OFFENDING_FRAME_TYPE = int(DiagnosticType.OFFENDING_FRAME_TYPE)

EXT_PRIORITY_UPDATE = int(ExtensionSubtype.PRIORITY_UPDATE)
