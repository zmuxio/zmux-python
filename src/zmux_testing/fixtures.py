...
def locate_fixture_dir(search_from: PathLike | None = None) -> Path:
...
def load_fixture_ndjson(name: PathLike, fixture_dir: PathLike | None = None) -> List[Any]:
...
def read_fixture_json(name: PathLike, fixture_dir: PathLike | None = None) -> Any:
...
def _cached_fixture_dir(search_from: PathLike | None) -> Optional[Path]:
    global _FIXTURE_DIR
...
def _fixture_path(name: PathLike, fixture_dir: PathLike | None) -> Path:
    name_path = Path(name)
